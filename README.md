...
- **Current runtime readiness: `runtime_enablement_candidate`** — strict non-allow blocking, role revoke governed, and capability gate per action are now enforced. All validators, docs, and tests truthfully reflect this posture. Approval execution relay remains metadata-only/deferred; runtime execution remains disabled for deferred capabilities.
