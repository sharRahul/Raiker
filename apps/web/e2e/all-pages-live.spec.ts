...
test("capture every application page from a live fresh instance", async ({ page }) => {
  ...
  // so a sweep that does not finish it photographs the wizard twenty-six times
  // instead of the pages underneath. The shared sign-in does that as part of
  // arriving, from whichever stage the workspace resumes on.
