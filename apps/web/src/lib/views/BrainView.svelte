...
<style>
  ...
  .inspector { padding:18px; width:280px; bottom:14px; } .inspector .close,.source-modal .close { position:absolute; right:12px; top:9px; } .record-kicker { display:flex; align-items:center; gap:7px; color:var(--text-3); text-transform:uppercase; letter-spacing:.11em; font-size:var(--text-2xs); } .inspector h3 { margin:10px 24px 4px 0; font-size:var(--text-base); } .status-line { display:flex; gap:8px; color:var(--text-3); font-size:var(--text-2xs); } .status-line span { padding:3px 6px; border:1px solid var(--border); border-radius:4px; } .inspector > p { color:var(--text-2); font-size:var(--text-xs); line-height:1.55; } .inspector h4 { margin:20px 0 7px; color:var(--text-3); text-transform:uppercase; letter-spacing:.1em; font-size:var(--text-2xs); }
