...
<section class="search-chat">
  <header>  <GuideLink route="search-chat" />
<input type="search" placeholder="Search your chat history…" bind:value={query} aria-label="Search chat history" /></header>
