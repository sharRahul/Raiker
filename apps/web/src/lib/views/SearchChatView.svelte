...
<section class="search-chat">
  <header><p class="page-lead">Search titles and message text, then continue exactly where you left off.</p><input type="search" placeholder="Search your chat history…" bind:value={query} aria-label="Search chat history" /></header>
