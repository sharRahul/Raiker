...
> response exposes no filesystem path. Attachments, project memory, and
> reminder scheduling are excluded from this slice. Real reminders and
> routines remain the next backlog work.
