...
> `plugin_revoked` before any broker call. Arbitrary plugin code/import/process/
> network/write execution remains deferred. Where the older 2026-06-22 paragraph
> below says "plugins" have no executor, read that as "arbitrary plugin code
