...
| Approval phishing over a channel | A channel is used to *ask for* an approval rather than answer one | Approval relay is deliberately the last channel step and is unbuilt | Action binding, sender must be the paired owner, freshness check |
