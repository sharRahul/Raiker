...
> `docs/architecture/SECURITY_AND_POLICY.md` → "Security Philosophy".
...
Use `docs/architecture/ADR_TEMPLATE.md` before implementation if a change would:
...
- [ ] Events are listed in `docs/architecture/EVENT_CATALOG.md`.
