...
This document is the strict schema reference for Raiker plugin manifests. It complements `docs/architecture/PLUGIN_SYSTEM_SPEC.md` and the Raiker-native inventory in [`docs/architecture/RAIKER_TOOL_AND_PLUGIN_CATALOG.md`](RAIKER_TOOL_AND_PLUGIN_CATALOG.md).
