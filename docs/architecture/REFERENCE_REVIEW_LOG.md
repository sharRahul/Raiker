...
**Historical record.** This is the dated, source-backed working that
[`REFERENCE_PLATFORM_COMPATIBILITY.md`](REFERENCE_PLATFORM_COMPATIBILITY.md) —
the canonical comparison — is drawn from. Each review states the date it was
run, the platforms it was run against, and the scope it covered.

**Where a review and the canonical document disagree, the canonical document is
current.** These rounds are kept because they carry the reasoning and the
evidence behind a decision, not because every row in them is still true. Nothing
here is maintained against the code.

It was split out of the comparison document on **2026-08-23**, for the reason
the split exists elsewhere in this repository: a canonical document that also
carries every dated round it went through stops describing the product as it is
and starts being an accumulation of the passes that got there. The comparison
answers *how does Raiker compare now*; this answers *how was that concluded, and
when*.

Rounds are newest-first within each group, as they were written.
...
|---|---|---|---|
| Hook lifecycle events | Claude Code documents **31** events. [Hooks](https://code.claude.com/docs/en/hooks) | Sixteen events accepted and **all sixteen emitted**; the accepted set and the emitted set are equal, derived from the call sites by a test so they cannot drift | **Partial** — *corrected 2026-08-23: this row previously read "at parity", which was parity with Raiker's own event list rather than with the reference. Raiker covers 16 of Claude Code's 31; see [§2.5](REFERENCE_PLATFORM_COMPATIBILITY.md#25-extensibility--hooks) for the 15 that have no equivalent* |
...
status**. For status, read [Part 2](REFERENCE_PLATFORM_COMPATIBILITY.md#2-canonical-capability-matrix). They are
...
|---|---|
| Agentic coding loop | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Tools reference | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md` |
| Interactive mode | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Rich terminal UX | `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Checkpointing | `docs/architecture/CHECKPOINTING_AND_REWIND_SPEC.md` |
| Hooks | `docs/architecture/HOOKS_SPEC.md` |
| Plugins | `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Channels | `docs/architecture/CHANNELS_SPEC.md`, `raiker/config/channel-connectors.json` |
| Commands | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| TUI-first command reference | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md`, `docs/architecture/ARCHITECTURE.md` |
| Session events | `docs/architecture/HOOKS_SPEC.md`, `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Tool events | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md`, `docs/architecture/HOOKS_SPEC.md` |
| Permission requests | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md` |
| Subagents/tasks | `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md`, `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Worktrees/execution | `docs/architecture/EXECUTION_ENVIRONMENTS_SPEC.md` |
| Context compaction | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
...
|---|---|---|
| `how-claude-code-works` (gather→act→verify loop, harness) | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/RUNTIME_STATE_MACHINE.md` | ✅ loop real; 🟡 verify/context stubs |
| `tools-reference` (built-in tools + permission per tool) | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md` | ✅ read tools; write/shell approval-gated |
| `interactive-mode` (REPL, shortcuts, steer/interrupt) | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` | ✅ basic REPL |
| `commands` / slash commands (built-in + custom) | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` | ✅ 50+ inspection commands |
| `cli-reference` (flags: `--prompt`, `--workspace`, resume/fork) | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md`, `README.md` | 🟡 `--prompt`/`--workspace` only |
...
> these shapes; see `docs/architecture/HOOKS_SPEC.md` and `docs/architecture/CHANNELS_SPEC.md`.
...
|---|---|
| Local-first gateway/control plane | `docs/architecture/ARCHITECTURE.md`, `docs/architecture/CHANNELS_SPEC.md` |
| Multi-channel inbox | `docs/architecture/CHANNELS_SPEC.md`, `raiker/config/channel-connectors.json`, `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md` |
| Channel pairing and sender allowlists | `docs/architecture/CHANNELS_SPEC.md`, `docs/architecture/SECURITY_AND_POLICY.md` |
| Channel-to-agent routing | `docs/architecture/CHANNELS_SPEC.md`, `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md` |
| Gateway daemon mode | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md`, `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md` |
| Voice wake/talk mode equivalent | `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md`, `docs/architecture/CHANNELS_SPEC.md` |
| Live canvas/workspace equivalent | `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md`, `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md` |
| Companion apps/nodes | `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md`, `docs/architecture/CHANNELS_SPEC.md` |
| Onboarding and connector setup | `docs/architecture/CHANNELS_SPEC.md`, `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md` |
| Skills from bundled/global/workspace scopes | `docs/architecture/PLUGIN_SYSTEM_SPEC.md`, `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md` |
| Channel security diagnostics | `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md`, `docs/architecture/VERIFICATION_PLAN.md` |
...
| Concept | Raiker specification |
|---|---|
| Tool-using agent loop | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Model-router/provider abstraction | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md`, `raiker/config/model-profiles.json` |
| Global `raiker` TUI entry and in-TUI provider launch | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md`, `docs/architecture/ARCHITECTURE.md`, `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| Structured tool proposal | `docs/architecture/CONTRACTS.md`, `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md` |
| Verification/reflection | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/VERIFICATION_PLAN.md` |
| Local-first inference support | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| Full TUI with streaming output | `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Interrupt and redirect | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Cross-channel conversation continuity | `docs/architecture/CHANNELS_SPEC.md`, `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` |
| Closed learning loop | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Skill creation and skill improvement | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md`, `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Full-text session search with summaries | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| User modelling from confirmed facts | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Scheduled automations | `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md`, `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md` |
| Parallel subagents | `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md` |
| Multiple execution backends | `docs/architecture/EXECUTION_ENVIRONMENTS_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| Raw observation capture | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Observation checksum and artifact reference | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md`, `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` |
| Gist memory compression | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Exact replay with provenance | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Retention classes | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Memory deletion/forgetting | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Skill learning from trajectories | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md`, `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md` |
...
| Concept | Raiker specification |
|---|---|
| Multi-agent teams | `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md` |
| Subagent roles | `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md` |
| Background task progress | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Team UI | `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md`, `docs/architecture/VISUAL_DESIGN_SPEC.md`, `docs/architecture/WEB_UI_CONTROL_DECK_PLAN.md` |
| Agent recursion limits | `docs/architecture/MULTI_AGENT_AND_SUBAGENT_STRATEGY.md` |
| Enterprise security/governance | `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md`, `docs/architecture/FULL_PHASE_IMPLEMENTATION_BLUEPRINT.md` |
...
| Concept | Raiker specification |
|---|---|
| Project graph extraction | `docs/architecture/GRAPH_MEMORY_AND_CODEMAP_SPEC.md` |
| Symbols/entities/relations | `docs/architecture/GRAPH_MEMORY_AND_CODEMAP_SPEC.md` |
| Graph queries | `docs/architecture/GRAPH_MEMORY_AND_CODEMAP_SPEC.md` |
| Graph-backed context retrieval | `docs/architecture/GRAPH_MEMORY_AND_CODEMAP_SPEC.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Staleness detection | `docs/architecture/GRAPH_MEMORY_AND_CODEMAP_SPEC.md` |
| Recursive CTE traversal | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| Procedural workflows | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Skill packaging | `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Skill activation | `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Skill safety/verification | `docs/architecture/PLUGIN_SYSTEM_SPEC.md`, `docs/architecture/VERIFICATION_PLAN.md` |
| Skill self-improvement | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| User/profile memory | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Project memory | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Episodic memory | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Procedural memory | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Semantic/vector memory | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` |
| Memory scoring/provenance | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Memory correction/forgetting | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Memory poisoning controls | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Eidetic observation and gist memory | `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| Local inference profiles | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md`, `raiker/config/model-profiles.json` |
| Provider abstraction | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| TUI model launch | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Context windows | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| Quantisation/hardware notes | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| Streaming | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
| Tool-call modes for local models | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md` |
...
| Concept | Raiker specification |
|---|---|
| Agent framework vs runtime distinction | `docs/architecture/ARCHITECTURE.md`, `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
| Durable execution | `docs/architecture/CHECKPOINTING_AND_REWIND_SPEC.md` |
| Human-in-the-loop | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Streaming | `docs/architecture/MODEL_RUNTIME_AND_LOCAL_INFERENCE.md`, `docs/architecture/COMMANDS_AND_INTERACTIVE_MODE_SPEC.md` |
| Persistence | `docs/architecture/CHECKPOINTING_AND_REWIND_SPEC.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Low-level orchestration | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| Prompt injection | `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Sensitive data disclosure | `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Supply chain | `docs/architecture/PLUGIN_SYSTEM_SPEC.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Memory/data poisoning | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Improper output handling | `docs/architecture/TOOLS_AND_PERMISSIONS_SPEC.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Excessive agency | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| System prompt leakage | `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Vector/embedding weaknesses | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Misinformation | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/VERIFICATION_PLAN.md` |
| Unbounded consumption | `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md`, `docs/architecture/EXECUTION_ENVIRONMENTS_SPEC.md` |
...
| Concept | Raiker specification |
|---|---|
| Reusable named skill unit | `docs/architecture/EXTENSIBILITY_MODEL.md`, `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Skill distilled from a successful trajectory | `docs/architecture/SELF_IMPROVEMENT_MODEL.md` |
| On-demand skill load (cheap until used) | `docs/architecture/EXTENSIBILITY_MODEL.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Skill activation gated by review | `docs/architecture/SELF_IMPROVEMENT_MODEL.md`, `docs/architecture/PLUGIN_SYSTEM_SPEC.md` |
| Skill safety/verification before reuse | `docs/architecture/SELF_IMPROVEMENT_MODEL.md`, `docs/architecture/VERIFICATION_PLAN.md` |
| Confidence/decay/forgetting of skills | `docs/architecture/SELF_IMPROVEMENT_MODEL.md` |
...
|---|---|
| `add` memory from interactions (candidate-first) | `docs/architecture/MEMORY_GOVERNANCE_RULES.md`, `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| `search` (semantic + keyword hybrid) | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` (FTS5 + BM25 + vector metadata) |
| `retrieve` filtered by scope/metadata | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| User / session / agent memory scopes | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Provenance + confidence scoring | `docs/architecture/MEMORY_GOVERNANCE_RULES.md` |
| Update / correct / forget | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md` |
| Self-hosted/local-first deployment | `docs/architecture/ARCHITECTURE.md` (local-first, SQLite-backed) |
...
| Concept | Raiker specification |
|---|---|
| Embedding-backed memory index | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` (vector metadata tables) |
| Semantic retrieval over session history | `docs/architecture/MEMORY_AND_CONTEXT_STRATEGY.md`, `docs/architecture/EIDETIC_MEMORY_AND_LEARNING_SPEC.md` |
| Hybrid lexical + vector ranking | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` (FTS5 + BM25 relevance + vector; see the retrieval control set below) |
| Sensitivity/provenance filters on retrieval | `docs/architecture/MEMORY_GOVERNANCE_RULES.md`, `docs/architecture/OWASP_GENAI_SECURITY_MAPPING.md` |
| Vector store backend abstraction | `docs/architecture/STORAGE_DATABASE_AND_SEARCH_SPEC.md` |
