...
This document is the canonical transition table for Raiker turn execution. `docs/architecture/RUNTIME_ORCHESTRATION_SPEC.md` describes orchestration behaviour; this file defines exact Phase 1 states, legal transitions, emitted events, guards, and terminal conditions.
