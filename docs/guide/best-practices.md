...
- Enable only the capabilities a task actually needs. For integrated
  capabilities, keep unused or high-risk gates disabled deliberately;
  no-executor capabilities remain disabled/fail-closed by design.
