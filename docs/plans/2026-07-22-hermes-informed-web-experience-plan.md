...
| 2 | partial | Workbench summaries, chat/session links, a persistent chat host, task cadence choices, session bulk actions, approval previews, and client-side risk/newest approval triage ordering exist. Session detail side panel/cross-links, approval expiry/step-up flow, and browser E2E coverage are not complete. |
