...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--workspace", default=".", help="Workspace root for local Phase 1 runtime state.")
    parser.add_argument("--prompt", default=None, help="Submit one prompt through the terminal client path and exit.")
