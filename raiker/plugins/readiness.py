...
PLUGIN_SERVER_READINESS_DISABLED_REASON = (
    "phase3_slice_n_metadata_only_plugin_server_startup_not_enabled"
)
...
class PluginServerStartupReadinessContract:
    ...
    def readiness_id(self) -> str:
        ...
        return deterministic_hash_id("pssr", payload)
...
def create_plugin_server_startup_readiness_contract(
    **kwargs: Any,
    ...
    return PluginServerStartupReadinessContract(
