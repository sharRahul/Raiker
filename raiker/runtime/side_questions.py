...
class SideQuestionRuntime:
    ...
    def answer_read_only(
        self, *, session_id: str, parent_turn_id: str, question: str, answer: str
    ) -> SideQuestionTurn:
        ...
        if self.writer:
            self.writer.append(
                make_event(
                    ...
                    turn_id=turn.child_turn_id,
                    event_type="side_question_received",
                    actor="runtime",
                    payload={"parent_turn_id": parent_turn_id, "read_only": True},
                )
            )
            self.writer.append(
                make_event(
                    session_id=session_id,
                    turn_id=turn.child_turn_id,
                    event_type="side_question_answered",
                    actor="runtime",
