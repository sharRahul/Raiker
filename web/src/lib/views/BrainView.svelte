...
<style>
  ...
  /* "Graph settings" is the heading of the panel it sits on, not a
  ...
  .panel-divider { margin:0; padding:14px 16px 4px; color:var(--text-3); font-size:var(--text-2xs); font-weight:700; letter-spacing:.09em; text-transform:uppercase; }
